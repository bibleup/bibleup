...
exports.default = {
    ...
    async load(spec, _isSSR, { config, lockfile }) {
        let body;
        if (spec.startsWith('-/') ||
            spec.startsWith('pin/') ||
            spec.startsWith('new/') ||
    ...
    async resolvePackageImport(_source, spec, config) {
        return path_1.default.posix.join(config.buildOptions.metaUrlPath, 'pkg', spec);
    },
    clearCache() {
