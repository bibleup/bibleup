...
export interface PackageSource {
     ...
     */
    load(spec: string, isSSR: boolean, options: {
        config: SnowpackConfig;
        lockfile: LockfileManifest | null;
    }): Promise<undefined | {
    ...
    resolvePackageImport(source: string, spec: string, config: SnowpackConfig, importMap?: ImportMap, depth?: number): Promise<string>;
