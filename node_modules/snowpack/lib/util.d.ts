...
import type { InstallTarget } from '../vendor/types/esinstall';
import { SkypackSDK } from '../vendor/types/skypack';
...
export declare const REQUIRE_OR_IMPORT: (id: string) => Promise<any>;
...
export declare function getCacheKey(fileLoc: string, { isSSR, env }: {
    isSSR: any;
    env: any;
}): string;
